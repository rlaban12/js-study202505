...
const traderInformation = traders.filter( (trader) => { return trader.year > 2022 } );
const traderName = traderInformation.map( (trader) => { return trader.trader.name } );
const traderCity = traderInformation.map( (trader) => { return  trader.trader.city } );

console.log(traderInformation);
